...
public class Product 
{
    ...
    public string CategoriesJson {set => Categories = JsonSerializer.Deserialize<List<Category>>(value);}
    ...
    public string RelatedProductsJson { set => RelatedProducts =  JsonSerializer.Deserialize<List<int>>(value);}
